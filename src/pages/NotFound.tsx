      ...
      <div className="relative text-center px-4 max-w-2xl mx-auto">
        ...
        <div className="mb-8 flex justify-center">
          <div className="relative">
            ...
            <div className="relative bg-linear-to-br from-primary/20 to-accent/20 p-6 rounded-full border border-primary/30">
        ...
        {/* 404 Text */}
        <h1 className="mb-4 text-8xl font-bold bg-linear-to-r from-primary via-accent to-primary bg-clip-text text-transparent animate-pulse">
          404
        </h1>
